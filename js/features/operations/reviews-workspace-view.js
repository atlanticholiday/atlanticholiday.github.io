  ...
  return `${renderReviewWorkspaceStyles()}${renderWorkflowStyles()}
    <div class="reviews-page-wrapper rr-shell">
      ...
      <header class="rr-header">
        <div class="rr-heading"><div class="rr-brand"><button id="reviews-back-btn" class="rr-back" aria-label="${tx('back')}">←</button><div class="rr-brand-icon" aria-hidden="true"><svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg></div><div><h1>${tx('title')}</h1><p>${tx('subtitle')}</p></div></div>
