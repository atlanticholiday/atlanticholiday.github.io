...
const ALL_INFO_CATEGORIES = [
    ...
    { title: 'Online Services', titlePt: 'Serviços online', slug: 'online-services', fields: ['onlineComplaintBooksEnabled', 'onlineComplaintBooksEmail', 'onlineComplaintBooksPassword', 'airbnbLinksStatus', 'airbnbListingUrl', 'bookingListingUrl'], icon: 'fas fa-globe' },
...
const FIELD_LABELS_PT = {
    ...
    airbnbListingUrl: 'Link Airbnb',
    bookingListingUrl: 'Link Booking.com',
