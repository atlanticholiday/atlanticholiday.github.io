                ...
                ${canConfigureCompliance ? `
                    <div class="${activeTimeClockSection === 'configuration' ? '' : 'hidden'} rounded-3xl border ${missingComplianceFields.length ? 'border-amber-300 bg-amber-50/60' : 'border-emerald-200 bg-emerald-50/40'} p-5">
                        ...
                        <form id="attendance-compliance-form" class="mt-5 grid gap-3 md:grid-cols-2">
                            ...
                            <input name="privacyContact" type="text" inputmode="tel" maxlength="254" value="${complianceField('privacyContact')}" class="rounded-xl border border-slate-300 bg-white px-4 py-3" placeholder="${t('timeClock.compliance.privacyContact')}">
