...
async function seed(collectionName, documentId, fields) {
  const url = `http://127.0.0.1:8080/v1/projects/demo-horario/databases/(default)/documents/${collectionName}/${documentId}`;
...
try {
  ...
  await page.goto(`http://127.0.0.1:${port}/tests/firestore-rules.html`, { waitUntil: 'domcontentloaded' });
  await page.waitForFunction(() => Boolean(window.__firestoreRulesResult), null, { timeout: 30000 });
